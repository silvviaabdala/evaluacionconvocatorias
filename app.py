...
# ── Siempre responder JSON, nunca HTML de error ───────────────────
...
def too_large(e):
    return jsonify({"ok": False,
        "error": "Archivo demasiado grande. Usa formato .md o .txt para reducir el tamaño."}), 413
...
def call_claude(api_key, conv_text, candidates):
    ...
    # Extraer solo el bloque JSON si hay texto alrededor
